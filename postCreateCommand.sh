...
sudo rstudio-server start --auth-none=1 --auth-validate-users=0 --server-user 'rstudio'
jupyter notebook --NotebookApp.token='' --NotebookApp.password='' --allow-root --port=8889